...
routes = [user_router, auth_router, timer_router,
          achievements_router, routine_router, statistics_router, organisation_router, notification_router, todo_router, kanban_router, organisation_tasks_router, custom_tasks_router, group_router]
